...
## About LGZ bot
* 这是使用[Shiro](https://github.com/MisakaTAT/Shiro)开发的机器人 理论支持任何 OneBot11 协议的框架
* 本机器人可以为使用者提供群消息合规性检查,并作出相应的处罚.
* 还有一些有趣的小东西 \>_\<

## Next Gen
* 由于mirai框架持续遭受封堵 我们决定放弃mirai框架
...
## JetBrains
* We are using JetBrains Intellij IDEA.
